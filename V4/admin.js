(function(){
  ...
  var STATUTS = ['Recue','BAT envoye','BAT valide','En production','En cours de livraison','Expediee','Annulee'];
  var STATUT_LABELS = {
    'Recue':'Reçue',
  ...
  function badgeClass(statut){
    ...
    if(statut==='BAT envoye'||statut==='BAT valide') return 'b-bat';
