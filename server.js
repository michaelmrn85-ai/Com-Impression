    ...
    const gammes = order.map(group => {
        const legacyProducts = LEGACY_CATALOG_DISABLED ? [] : (cat[group.legacy] || []).filter(prod => {
            ...
            const product = {
                ...
                sizeInfo: String(override.sizeInfo || '').trim(),
                ...
                deliveryDelayHours: override.deliveryDelayHours == null || override.deliveryDelayHours === '' ? null : Number(override.deliveryDelayHours),
        ...
        const extraProducts = customProducts
            ...
            .map(item => {
                ...
                return {
                    ...
                    title: item.title,
                    sizeInfo: String(item.sizeInfo || '').trim(),
                    ...
                    deliveryDelayHours: item.deliveryDelayHours == null || item.deliveryDelayHours === '' ? null : Number(item.deliveryDelayHours),
...
function defaultSiteConfig() {
    return {
        ...
        homeBannerText: 'Un accueil simple pour choisir vos supports, préparer vos fichiers et suivre vos commandes.',
        homeBannerButtonLabel: 'Voir les produits',
        homeBannerButtonUrl: './produits.html',
...
app.post('/api/admin/products/:legacyCat/:productId', express.json(), (req, res) => {
    ...
    try {
        ...
        const next = {
            ...
            sizeInfo: String(body.sizeInfo || '').trim(),
            ...
            deliveryDelayHours: parseNumberValue(body.deliveryDelayHours),
